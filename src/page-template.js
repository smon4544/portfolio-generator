...
// This function, generateAbout(), will accept the about variable as a parameter, and if it doesn't exist, we'll simply return 
// an empty string. If it does exist, however, we'll return the entire <section> element.
...
// create another function to handle generating the project HTML data
